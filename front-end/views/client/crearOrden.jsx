...
export default function CrearOrdenPage({ loggedUser, environment, errorInformation=null, final=false, divisas=null, precioPorDivisa=null, divisaApesos=null, lastform=null }) {
    return (
        <>
