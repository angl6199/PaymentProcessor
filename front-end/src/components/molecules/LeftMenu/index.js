                ...
                <div className="scroll-overflow">
                    ...
                    <Link className={`text-decoration-none`} to={`/${loggedUser.nombre}-${loggedUser.apellidos}/pagos-recibidos`}>
                        <div className={'d-flex align-items-center option mt-5'}>
                            <img alt="" className={'ml-14'} width={20} height={20} src={Money}></img><p className={`ml-3 mt-0 mb-0 a-light-dark text-medium`}>Pagos realizados</p>
                        </div>
                    </Link>
                    <Link className={`text-decoration-none`} to={`/${loggedUser.nombre}-${loggedUser.apellidos}/crear-orden`}>
                        <div className={'d-flex align-items-center option mt-4'}>
                            <img alt="" className={'ml-14'} width={20} height={20} src={AddPaymentIcon}></img><p className={`ml-3 mt-0 mb-0 a-light-dark text-medium`}>Crear pago</p>
                        </div>
                    </Link>
                    <Link className={`text-decoration-none`} to={`/${loggedUser.nombre}-${loggedUser.apellidos}/abonos-recibidos`}>
                        <div className={'d-flex align-items-center option mt-5'}>
                            <img alt="" className={'ml-14'} width={20} height={20} src={Money}></img><p className={`ml-3 mt-0 mb-0 a-light-dark text-medium`}>Abonos recibidos</p>
                        </div>
                    </Link>
                    ...
                    <Link className={`text-decoration-none`} to={`/${loggedUser.nombre}-${loggedUser.apellidos}/administracion-usuarios`}>
                        <div className={'d-flex align-items-center option mt-5'}>
                            <img alt="" className={'ml-14'} width={20} height={20} src={AdministracionUsuariosIcon}></img><p className={`ml-3 mt-0 mb-0 a-light-dark text-medium`}>Administración</p>
                        </div>
                    </Link>
                    <Link className={`text-decoration-none`} to={`/${loggedUser.nombre}-${loggedUser.apellidos}/crear-usuario`}>
                        <div className={'d-flex align-items-center option mt-4'}>
                            <img alt="" className={'ml-14'} width={20} height={20} src={AddUserIcon}></img><p className={`ml-3 mt-0 mb-0 a-light-dark text-medium`}>Crear usuario</p>
                        </div>
                    </Link>
                    ...
                    <div onClick={handleLogout} className={'d-flex align-items-center option mt-4 mb-4 cursor-pointer'}>
                        <img alt="" className={'ml-14 mt-0'} width={20} height={20} src={Logout}></img><p className={`ml-3 a-light-dark text-medium mt-0 mb-0`}>Salir</p>
                    </div>
                </div>
            </div>
